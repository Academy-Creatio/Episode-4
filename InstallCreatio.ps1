...
$psqlCmd = "docker exec -it postgresdb_db_1 pg_restore -U Supervisor --no-owner --no-privilege -d ${dbName} /usr/local/db/${dbFileName}";
Invoke-Expression $psqlCmd;
...
$redisAttr.Value = "host=localhost; db=${redisDbNum}; port=6380";
...
$clioCmd = "C:\clio\clio\bin\Debug\netcoreapp3.1\clio.exe set-syssetting ShowWidgetOnIntroPage false Boolean -e ${AppName}";
Invoke-Expression $clioCmd;

#Do NOT Show widget on login page
$clioCmd = "C:\clio\clio\bin\Debug\netcoreapp3.1\clio.exe set-syssetting ShowWidgetOnLoginPage false Boolean -e ${AppName}";
Invoke-Expression $clioCmd;

#set Default TimeZone to "Helsinki, Kyiv, Riga, Sofia, Tallinn, Vilnius (GMT+02:00)"
$clioCmd = "C:\clio\clio\bin\Debug\netcoreapp3.1\clio.exe set-syssetting DefaultTimeZone 97c71d34-55d8-df11-9b2a-001d60e938c6 Lookup -e ${AppName}";
Invoke-Expression $clioCmd;

#set Session Timeout, Max is 720 minutes (12 hours)"
$clioCmd = "C:\clio\clio\bin\Debug\netcoreapp3.1\clio.exe set-syssetting UserSessionTimeout 720 Integer -e ${AppName}";
Invoke-Expression $clioCmd;

#Disable updating contact ages
$clioCmd = "C:\clio\clio\bin\Debug\netcoreapp3.1\clio.exe set-syssetting ActualizeAge false Boolean -e ${AppName}";
Invoke-Expression $clioCmd;
$clioCmd = "C:\clio\clio\bin\Debug\netcoreapp3.1\clio.exe set-syssetting RunAgeActualizationDaily false Boolean -e ${AppName}";
Invoke-Expression $clioCmd;

#Enable Debug mode
$clioCmd = "C:\clio\clio\bin\Debug\netcoreapp3.1\clio.exe set-syssetting IsDebug true Boolean -e ${AppName}";
Invoke-Expression $clioCmd;

$clioCmd = "C:\clio\clio\bin\Debug\netcoreapp3.1\clio.exe set-syssetting SchemaNamePrefix ' ' Text -e ${AppName}";
Invoke-Expression $clioCmd;
...
$clioCmd = "C:\clio\clio\bin\Debug\netcoreapp3.1\clio.exe set-syssetting ExchangeListenerServiceUri 'http://${myHost}:10000/api/listeners' Text -e ${AppName}";
Invoke-Expression $clioCmd;

$clioCmd = "C:\clio\clio\bin\Debug\netcoreapp3.1\clio.exe set-syssetting BpmonlineExchangeEventsEndpointUrl 'http://${myHost}:${port}/0/ServiceModel/ExchangeListenerService.svc/NewEmail' Text -e ${AppName}";
Invoke-Expression $clioCmd;
